...
public class UriMethod {
    ...
    //图片上传下载接口地址前缀
    public static final String SERVER_HOST_IMG_UPLOAD_DOWNLOAD = "file/v1/api/";
    //我的任务列表接口 地址前缀
    public static final String SERVER_HOST_MY_TASK_LIST = "feed/v1/api/mytask/";
    //用户设置接口 地址前缀
    public static final String SERVER_HOST_USER_SETTING = "uinfo/v1/api/config/";
    //评价和分享上报接口 地址前缀
    public static final String SERVER_HOST_COMMENT_SHARE = "feed/v1/api/evaluation/";
    //服务流程接口地址前缀
    public static final String SERVER_HOST_SERVICE = "feed/v1/api/service/";
    //消息系统接口 地址前缀
    public static final String SERVER_HOST_MESSAGE_SYSTEM = "msg/v1/api/";
    //服务者推荐接口 地址前缀
    public static final String SERVICE_USER_RECOMMEND = "uinfo/v1/api/sp/recommend";
    //需求者推荐接口  地址前缀
    public static final String DEMAND_USER_RECOMMEND = "uinfo/v1/api/dp/recommend";
    //客服系统接口地址前缀
    public static final String CUSTOMER_SERVICE = "customer/v1/api";
    //ZSS
    public static final String SERVER_HOST_SKILLLABEL = "";
    public static final String SERVER_HOST_BAR = "search/v1/api";

    //zss [我的模块]
    public static final String SERVER_HOST_MY_USERINFO = "uinfo/v1/api";
    //ZSS 我的账户
    public static final String SERVER_HOST_MY_ACCOUNT = "uinfo/v1/api/wallet";

    //[推荐]-首页上部活动广告
    public static final String FIRST_PAHER_ADVERTISEMENT_ONE = "static/ad" + "/1";
    public static final String FIRST_PAHER_ADVERTISEMENT_TWO = "static/ad" + "/2";
    public static final String FIRST_PAHER_ADVERTISEMENT_THREE = "static/ad" + "/3";
    //[闲时]-更多服务列表查询
    public static final String FREE_TIME_MORE_HOST = "leisure/v1/api";
    ...
    //[推荐]-首页需求推荐列表
    public static final String RECOMMEND_DEMAND_HOST = "feed/v1/api/demand/recommend";
    public static final String FIRST_PAGER_DEMAND_LIST = RECOMMEND_DEMAND_HOST + "/list";
    public static final String RECOMMEND_SERVICE_HOST = "feed/v1/api/service/recommend";
...
//        public static final String SEND_PHONE_VERIFICATION_CODE = "auth/phone";
    ...
    //手机验证码验证
    public static final String VERIFICATION_PHONE_VERIFICATION_CODE = "auth/v1/pin";
    //变更手机号
    ...
    //token登录
    public static final String TOKEN_LOGIN = "auth/v1/login/token";
    //第三方登录
    public static final String THIRD_PARTY_LOGIN = "auth/v1/login/thirdParty";
    //获取融云token
    public static final String GET_RONG_TOEKN = "auth/v1/rongToken";
    //更新融云token
    public static final String REFRESH_RONG_TOKEN = "auth/v1/rongToken/update";
    //登录后完善信息 设置头像
    ...
    //登录后完善 获取技能标签
    public static final String LOGNI_GET_TAG = "static/tag/sys_tag.json";
    //登录后完善 设置技能标签(三级标签)
    ...
    //一、[用户认证]-真实用户认证接口
    public static final String REAL_USER_AUTH = "uinfo/v1/api/real/auth";
    //二、[用户认证]-查询用户认证状态接口
    public static final String GET_USER_AUTH_STATE = "uinfo/v1/api/real/status";
    //三、[用户信息]-获取用户名片接口
    public static final String GET_USER_VCARD = "uinfo/v1/api/vcard/info";
    //四、[用户信息]-用户资料接口(用于编辑用户资料加载)
    public static final String USER_PERSON_INFO = "uinfo/v1/api/vcard/person/info";
    //五、[用户信息]-获取用户技能标签
    public static final String GET_USER_SKILL_LABEL = "uinfo/v1/api/vcard/skilllabel/get";
    //六、[用户信息]-设置用户技能标签
    public static final String SET_USER_SKILL_LABEL = "uinfo/v1/api/vcard/skilllabel/set";
    //七、[用户信息]-系统技能标签库接口
    public static final String SYSTEM_SKILL_LABEL = "uinfo/v1/api/vcard/default/skill";
    //八、[用户信息]-添加斜杠职业
    public static final String ADD_SLASH_JOB = "uinfo/v1/api/vcard/profession/add";
    //九、[用户信息]-获取斜杠职业
    public static final String GET_SLASH_JOB = "uinfo/v1/api/vcard/profession/get";
    //十、[用户信息]-设置用户地区
    public static final String SET_USER_LOCATION = "uinfo/v1/api/vcard/location/set";
    //十一、[用户信息]-设置用户姓名
    public static final String SET_USER_NAME = "uinfo/v1/api/vcard/name/set";
    //十二、[用户信息]-设置用户性别
    public static final String SET_USER_GENDER = "uinfo/v1/api/vcard/sex/set";
    //十三、[用户信息]-设置用户技能描述
    public static final String SET_USER_SKILL_DESCRIPTION = "uinfo/v1/api/vcard/desc/set";
    //十四、[用户教育信息]-用户一个教育信息
    public static final String GET_ONE_USER_DEU_INFO = "uinfo/v1/api/vcard/edu/one";
    //十五、[用户教育信息]-删除一个教育信息接口
    public static final String DEL_ONE_USER_DEU_INFO = "uinfo/v1/api/vcard/edu/del";
    //十六、[用户教育信息]-增加一个教育信息接口
    public static final String ADD_ONE_USER_DEU_INFO = "uinfo/v1/api/vcard/edu/add";
    //十七、[用户工作经历信息]-获取用户全部教育信息
    public static final String GET_ALL_USER_EDU_INFO = "uinfo/v1/api/vcard/edu/all";
    //十八、[用户工作经历信息]-用户一个工作经历信息
    public static final String GET_ONE_USER_WORK_INFO = "uinfo/v1/api/vcard/cert/one";
    //十九、[用户工作经历信息]-删除一个工作经历接口
    public static final String DEL_ONE_USER_WORK_INFO = "uinfo/v1/api/vcard/cert/del";
    //二十、[用户工作经历信息]-增加一个工作经历接口
    public static final String ADD_ONE_USER_WORK_INFO = "uinfo/v1/api/vcard/cert/add";
    //二十一、[用户工作经历信息]-获取用户全部工作经历信息
    public static final String GET_ALL_USER_WORK_INFO = "uinfo/v1/api/vcard/cert/all";
    //二十二、[用户信息]-上传用户头像
    public static final String UPLOAD_USER_AVATAR = "uinfo/v1/api/vcard/avatar/upload";
    //二十三、[用户信息]-下载用户头像
    public static final String DOWNLOAD_USER_AVATAR = "uinfo/v1/api/vcard/avatar/upload";
    //二十四、[搜索]-联想词搜索
    ...
    //十五，[我的]-[用户中心]-用户认证流程状态
    public static final String MY_CHECKOUT_AUTH_SRATUS = "uinfo/v1/api" + "/real/status";
    //十六，[我的]-[用户中心]-登出
    public static final String MY_LOGOUT = "auth/v1/logout";
    ...
    //五，上传图片
    public static final String UPLOAD_PHOTO = "file/v1/api" + "/upload";
    // 五、[设置]-设置新的交易密码
    ...
    //第三方，获得第三方平台列表
    public static final String GET_BINDING = "auth/v1/login/getBind";
    //绑定第三方账号
    public static final String LOGIN_BINDING = "auth/v1/login/bind";
    //解绑第三方账号
    public static final String UNBINDING = "auth/v1/login/unbind";

    //我的收藏
    public static final String COLLECTION_HOST = "feed/v1/api/myfavorite";
    ...
    //管理我发布的
    public static final String MANAGE_PUBLISH_HOST = "feed/v1/api/mytaskmanagement";
    ...
    //[我的人脉]-人脉首页
    public static final String PERSON_RELATION_HOST = "uinfo/v1/api/relation";
    //人脉首页
    public static final String PERSON_RELATION_FIRST_PAGER = PERSON_RELATION_HOST + "/facade";
    //[我的访客]-访客列表
    public static final String MY_VISITOR_HOST = "uinfo/v1/api/relation/visitor";
    public static final String MY_VISITOR_LIST = MY_VISITOR_HOST + "/list";

    //一、[好友]-查看我的好友列表
    public static final String MY_FRIEND_LIST_HOST = "uinfo/v1/api/relation/friend";
    ...
    //三、[关注]-查询我关注的人
    public static final String RELATION_HOST = "uinfo/v1/api/relation/follow";
    ...
    //[推荐]-推荐好友
    public static final String RECOMMONEND_FRIEND_LIST = "uinfo/v1/api/friend/recommend" + "/list";
    //[推荐]-推荐好友黑名单接口
    public static final String RECOMMONEND_FRIEND_BLACK_LIST = "uinfo/v1/api/friend/recommend" + "/blacklist";
    ...
    //[帮助]-检测app新版本
    public static final String VERSION_HOST = "system/v1/api/config";
    public static final String CHECK_VERSION = VERSION_HOST + "/version/check";

    //首页banner
    public static final String BANNER_HOST = "static/ad";
    public static final String GET_BANNER_CONFIG = BANNER_HOST + "/banner_config";


    //二、[推广]-首页Tag配置信息接口  V1.1首页
    public static final String HOME_TAG_CONFIG = "static/type/type_config";
    //一、[标签]-标签查询 首页分级标签查询接口
    public static final String GET_TAG_RECOMMEND_LIST = "search/v1/api/index/tag";
    //一、[推荐]-首页需求推荐列表 v1.1首页需求推荐列表
    public static final String GET_RECOMMEND_DEMAND2 = "feed/v2/api/demand/recommend/list";
    //二、[推荐]-首页服务推荐列表 v1.1首页服务推荐列表
    public static final String GET_RECOMMEND_SERVICE2 = "feed/v2/api/service/recommend/list";
