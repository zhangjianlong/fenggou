 ...
 * @Desc:
 */
public class FollowNumUserCase extends UseCase<HistoryNumBean> {
    LoginRepository repository;

    @Inject
    public FollowNumUserCase(LoginRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable<HistoryNumBean> buildUseCaseObservable() {
        return repository.getFollowNum();
    }
}
