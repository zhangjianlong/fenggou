...
public abstract class BaseActListViewModel<D, V, T extends BaseListItemViewModel> extends BAViewModel<D> {
    ...
    public BaseActListViewModel(RxAppCompatActivity activity) {
        super(activity);
    }
